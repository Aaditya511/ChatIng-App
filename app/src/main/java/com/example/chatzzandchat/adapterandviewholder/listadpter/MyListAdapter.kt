...
import com.example.chatzzandchat.all_activites.all_adapter_viewholder.ReciverViewHolder
import com.example.chatzzandchat.all_activites.all_adapter_viewholder.SenderViewHolder
import com.google.firebase.auth.FirebaseAuth
import com.example.chatzzandchat.dataclasses.MyMessagesDataClass

class MyListAdapter(val context: Context, val arrayList:ArrayList<MyMessagesDataClass>): ListAdapter<MyMessagesDataClass, RecyclerView.ViewHolder>(MyDiffUtil()) {
    var itemSend = 1
    var itemRecive = 2
